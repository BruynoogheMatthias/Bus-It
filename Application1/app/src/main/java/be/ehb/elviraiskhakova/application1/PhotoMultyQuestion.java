...
public class PhotoMultyQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_multy_question);
...
//        Toast.makeText(this, "Ok", Toast.LENGTH_SHORT).show();
    ...
    private class ImageSelectListAdapter extends RecyclerView.Adapter<AnswerViewHolder> {
        ...
        public AnswerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new PhotoMultyQuestion.AnswerViewHolder(itemView);
        }
        ...
        public void onBindViewHolder(final AnswerViewHolder holder, final int position) {
            ...
            Picasso.with(PhotoMultyQuestion.this)
                    .load(answer)
                    .into(holder.answer);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (puzzle.getAnswerForImage(holder.getAdapterPosition())) {
                        ...
                        // wrong answer
                        Toast.makeText(PhotoMultyQuestion.this, "Wrong answer"
